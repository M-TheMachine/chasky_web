...
<div class="bg-gray-50 min-h-screen py-24">
    <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <p class="text-xl text-gray-600 mb-8">Hemos recibido tu solicitud de offshoring. Nuestro equipo revisará los detalles y te contactará pronto para discutir los siguientes pasos.</p>
            
            <div class="flex flex-wrap justify-center gap-4">
                <a href="/servicios/offshoring" class="bg-[#701516] text-white px-8 py-3 rounded-full font-bold hover:bg-[#701516]/90 transition duration-300">
                    Volver a Offshoring
                </a>
