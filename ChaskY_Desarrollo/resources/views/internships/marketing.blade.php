        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-xl p-8 shadow-lg">
                    ...
                    <p class="text-gray-700 mb-8 text-lg">{{ __('careers.positions.internship.marketing.description') }}</p>
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <ul class="list-disc list-inside text-gray-600 space-y-3">
                                @foreach(trans('careers.positions.internship.marketing.requirements') as $requirement)
                        ...
                        <div>
                            ...
                            <ul class="list-disc list-inside text-gray-600 space-y-3">
                                @foreach(trans('careers.positions.internship.marketing.offer') as $offer)
                                    <li class="flex items-start">
                                        <span class="text-[#701516] mr-2">•</span>
                                        <span>{{ $offer }}</span>
                                    </li>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-xl p-8 shadow-lg">
                    ...
                    <p class="text-gray-600 mb-8">{{ __('internships.marketing.form_description') }}</p>

                    <form action="{{ route('internships.marketing.apply') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            <label class="block text-gray-700 font-medium mb-2" for="portfolio">{{ __('internships.form.portfolio') }}</label>
                            <input type="url" name="portfolio" id="portfolio"
                                class="w-full px-4 py-3 rounded-lg border-gray-300 focus:border-[#701516] focus:ring-[#701516]"
                                placeholder="{{ __('internships.form.portfolio_placeholder') }}">
