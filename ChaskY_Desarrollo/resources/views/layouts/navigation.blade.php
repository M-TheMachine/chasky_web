            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('login') }}" class="text-sm text-gray-500 hover:text-gray-700">{{ __('Iniciar sesión') }}</a>
                        <a href="{{ route('register') }}" class="text-sm text-gray-500 hover:text-gray-700">{{ __('Registrarse') }}</a>
                    </div>
                @endauth
