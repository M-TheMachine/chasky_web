...
@section('content')
        ...
        <div class="container mx-auto px-4 py-24 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <p class="text-xl md:text-2xl text-gray-100 mb-12 leading-relaxed" data-aos="fade-up" data-aos-delay="100">
                    Sé parte de una empresa que está transformando el futuro digital
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                <div class="text-center mb-16" data-aos="fade-up">
                    <h2 class="text-3xl md:text-4xl font-bold mb-6 gradient-text">¿Por qué Chasky?</h2>
                    <p class="text-gray-600 text-lg">Descubre los beneficios de ser parte de nuestro equipo</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-xl p-8 shadow-lg" data-aos="fade-up">
                        ...
                        <p class="text-gray-600">Oportunidades de desarrollo y capacitación continua para potenciar tu carrera.</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-8 shadow-lg" data-aos="fade-up" data-aos-delay="100">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-bold">Ambiente Innovador</h3>
                        </div>
                        <p class="text-gray-600">Trabajo con tecnologías de vanguardia en un entorno que fomenta la creatividad.</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-8 shadow-lg" data-aos="fade-up" data-aos-delay="200">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-bold">Cultura Inclusiva</h3>
                        </div>
                        <p class="text-gray-600">Valoramos la diversidad y fomentamos un ambiente de trabajo colaborativo y respetuoso.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                <div class="text-center mb-16" data-aos="fade-up">
                    <h2 class="text-3xl md:text-4xl font-bold mb-6 gradient-text">Vacantes Actuales</h2>
                    <p class="text-gray-600 text-lg">Explora nuestras oportunidades laborales</p>
                </div>
